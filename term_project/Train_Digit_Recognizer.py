...
# 출력 이미지 경로
_DST_PATH = u'.\\images\\Train_Digit_Recognizer'
...
if __name__ == '__main__':
    ...
    #학습할 데이터들을 Denoising Auto Encoder에 통과시킴
    denoised_trDataList = denosingAutoEncoder.predict(pure_trDataList)
    print 'Data Denoising Done.\n'
    ...
    # 학습 진행 (10 Epochs)
    modelFull.fit(denoised_trDataList, trLabelList, epochs=10, batch_size=100)
    ...
    # 모델 구조 그리기
    ku.plot_model(modelFull, _DST_PATH + u'\\model\\Train_Digit_Recognizer.png') 
    print "\nA Image is saved in 'images\\Train_Digit_Recognizer' folder."
    
    # 모델 파라미터를 파일로 저장
    km.save_model(modelFull, 'Train_Digit_Recognizer_param.h5')
    print "'Train_Digit_Recognizer_param.h5' file is saved."
