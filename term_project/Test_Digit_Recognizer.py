...
if __name__ == '__main__':
    ...
    print 'Pure and Noise Data mixing done. (%d:%d)' % (pureRate*100, noiseRate*100)
    
    # DAE 모델 파라미터 로드
    denosingAutoEncoder = km.load_model('DAE_model_param.h5')
    
    # 70:30으로 섞어 놓은 Test Data들을 Denoising 시키기 위해 DAE를 통과시킴
    mixed_tsDataList = denosingAutoEncoder.predict(mixed_tsDataList)
